...
public class ProfileFragment extends Fragment {
    ...
    private static final int IMAGE_REQUES = 1;
    ...
    private void chooseImg() {
        ...
        startActivityForResult(intent, IMAGE_REQUES);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == IMAGE_REQUES && resultCode == RESULT_OK && data != null && data.getData() != null) {
